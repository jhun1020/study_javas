...
public class ApiExplorersWithDatagoKr_myself{
    public static void main(String[] args) throws UnsupportedEncodingException {
        ...
        urlBuilder.append("?" + URLEncoder.encode("ServiceKey","UTF-8") + "=").append("F8urQtWbXWR0eW72eAeRNVGCy5cvwfdcmi9pS%2FV30UzQidC1LUt2Aog6nAvaWENf72H2v4M09sz8d%2BcA%2B3y%2B%2Fw%3D%3D"); /*Service Key*/
        ...
        try {
            ...
            // conn.getInputStream()  실제 데이터가 있는 곳
